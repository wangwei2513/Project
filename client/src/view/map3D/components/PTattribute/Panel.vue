<template>
  <!-- <transition name="shrink"> -->
    <div v-show="isShowPTattr" class="panel" :class="{'offset': isShowToolsPanel}">
      ...
      <div class="btn-panel-shrink" @click="closePTattr">
        <div class="shape">
...
const { mapGetters, mapActions } = createNamespacedHelpers('map3DApplyIX')
export default {
  components: { AttrVideo, AttrAlarm, AttrAlarmHelp, AttrModel, AttrPatrol, AttrSinglePawn, AttrBuilding, AttrGrid },
  computed: {
    ...mapGetters(['isShowPTattr', 'attrInfo', 'isShowToolsPanel'])
  },
  methods: {
    ...mapActions(['closePTattr']),
    ...mapActions('map3DApplyIX', ['cleanAttrInfo'])
  },
  beforeDestroy() {
    this.cleanAttrInfo()
  }
