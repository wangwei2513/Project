<!-- 轨迹查询弹出框 -->
<template>
  <Modal v-model="showTrackModal" :mask-closable="false" :closable="false" :footer-hide="true" :width="560">
...
export default {
  ...
  data() {
    return {
      ...
      // 轨迹类型数据源
      trackTypes: [
        { text: '车辆轨迹', label: 'vehicle', value: 'vehicle', disable: true },
        { text: '人员轨迹', label: 'personnel', value: 'personnel', disable: true },
