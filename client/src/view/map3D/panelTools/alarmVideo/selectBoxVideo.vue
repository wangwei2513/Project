<template>
  ...
  @mousedown.stop @mouseup.stop class="Vmodel" id='selectBoxVideo'>
    ...
    <div class="select-video-body">
      <bs-video :pluginCOM="plugin" :count="5" :styles="styles" v-if="!showDownload && modalShow"
    ...
    <div slot="footer" class="footer">
      ...
      <div class="quick-to-wall-box" @mouseenter="showTowall=true" @mouseleave="showTowall=false">
...
export default {
  ...
  methods: {
    ...mapActions(['getTVList', 'getMonitorList', 'openWall', 'setIsBoxChoosePreview', 'setPreviewPointList']),
  ...
  mounted() {
    this.debounceFullScreen = this.$lodash.debounce(this.fullscreen, 300)
  },
  beforeDestroy() {
    videoPlugin = null
  }
