    ...
    <div class="video-diagnostic" v-resize="resize">
        ...
        <div class="video-diagnostic-r">
           <div class="video-diagnostic-r-table-title">
               ...
               <Button class="btn-rt lf" type="ghost" icon="archive" @click="deviceExport" style="margin-right:24px">导出</Button>
           ...
           <div class="video-diagnostic-r-table" ref="tableBox">
                <Table size="small" :height="tableHeight" :columns="columns" :data="tableData"></Table>
           </div>
