      ...
      <div class="video-monitor-right">
        ...
        <div class="tab-content">
          <div class="feature-btn">
            ...
            <Button type="ghost" class="btn-style" @click="refresh" style="margin-right:24px">
              <span class="iconfont icon-refresh"></span>刷新</Button>
            <Checkbox v-model="never">显示子机构资源</Checkbox>
          ...
          <VideoEquipment v-if="activeTab === 0" :tableHeight='tableHeight' @openModal='openModal' :videoData='videoData' :offlineColor='offlineColor' :onlineColor='onlineColor' :basicColor='basicColor'></VideoEquipment>
          <WarningFacility v-if="activeTab === 1" :tableHeight='tableHeight' @openModal='openModal' :videoData='alarmData' :offlineColor='offlineColor' :onlineColor='onlineColor' :basicColor='basicColor'></WarningFacility>
          <FireFightingApparatus v-if="activeTab === 2" :tableHeight='tableHeight' @openModal='openModal' :videoData='fireControlData' :offlineColor='offlineColor' :onlineColor='onlineColor' :basicColor='basicColor'></FireFightingApparatus>
          <DecodingDevice v-if="activeTab === 3" :tableHeight='tableHeight' @openModal='openModal' :videoData='decodeData' :offlineColor='offlineColor' :onlineColor='onlineColor' :basicColor='basicColor'></DecodingDevice>
          ...
          <PlatformServices v-if="activeTab === 4" :tableHeight='tableHeight' @openModal='openModal' :videoData='platformServices' :offlineColor='offlineColor' :onlineColor='onlineColor' :basicColor='basicColor'></PlatformServices>
