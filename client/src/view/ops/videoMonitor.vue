      ...
      <div class="video-monitor-right">
        <div class="video-monitor-right-action clear">
          <div class="fl">
            ...
            <Button @click="exportChannelsTable" style="margin-right:24px">
        ...
        <div class="video-monitor-right-table" ref="tableWrap">
          <Table size="small" :height="tableHeight" :columns="channelsTableColumns" :data="channelsTableData" :highlight-row="true" width="100%" style="overflow:auto"></Table>
