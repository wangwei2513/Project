        ...
        <div class="mapPosContent">
          ...
          <div v-if="isOuter" class="mapPositionCenter">
            ...
            <div v-if="flag" class="flagClss">
              <bs-map v-for="(item, index) in mapConfigList" :key="index" v-show="activeMap === item.mapId" :resolutions="item.resolutions" class="mapHome" :center="activeMapCenter || item.center" :extent="item.extent" ref="mapEditContainer" :updateSize="isUpdate" :zoom="1" @click="mapClickEvt" :showFullSrceen="true" :showRotate="true">
                <!-- geo -->
