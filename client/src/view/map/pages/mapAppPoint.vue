...
export default {
  ...
  methods: {
    ...
    devSelect(checkList) {
      ...
      let vediolist = appIpc.controlVedioVisibleByLevel(vedioSectors.vediolist, this.mapZoom)
      let sectorlist = appIpc.controlVedioVisibleByLevel(vedioSectors.sectorlist, this.mapZoom)
