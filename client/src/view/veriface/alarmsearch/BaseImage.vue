<template>
  <div class="base-image">
    ...
    <div class="picture-info clearfix">
			<span><i class="iconfont icon-Location"></i> {{picInfo.resName}}</span>
			<i class="iconfont icon-guijichaxun" title="轨迹追踪" @click="toRoute('/veriface/Track')"></i>
			<i class="iconfont icon-icon-test" title="以图搜图" @click="toRoute('/veriface/PasserSearch/searchpic')" style="margin-right:4px;"></i>
		</div>
		<div class="images clearfix">
			<i>{{picInfo.similar}}%</i>
			<div class="sing-img">
				<img :src="picInfo.faceImage?picInfo.faceImage:'/static/noImg1.png'" @click="showDetail = true" style="cursor:pointer;" draggable="false" @error="imgErr"/><br/>
			...
			<div class="sing-img clearfix" style="margin-left: 2px;">
				<img :src="picInfo.userImage?picInfo.userImage:'/static/noImg1.png'" draggable="false" @error="imgErr"/><br/>
