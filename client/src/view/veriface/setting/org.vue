        ...
        <div class="res-add-model">
          ...
          <div class="res-model-tree" v-if="addModal.isShow">
            <bs-scroll ref="scroller">
              <VTree @on-expand="$refs.scroller.update()" ref="resTree" :treeData="addModal.treeData" :options="addModal.addOptions">
              </VTree>
            </bs-scroll>
          </div>
        </div>
      ...
      <Modal :mask-closable="false" v-model="resMoveModal" title="资源移动" width="450">
        <div class="res-add-model">
          ...
          <div class="res-model-tree">
            <bs-scroll ref="scroller">
              <VTree @creatTreeEnd='$refs.scroller.update()' @on-expand="$refs.scroller.update()" :treeData="resMoveTreeData" :activeId="resMoveOrgId" :options="resMoveTreeOptions" @node-click="selectMoveOrg">
              </VTree>
            </bs-scroll>
          </div>
        </div>
