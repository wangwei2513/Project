<template>
  <div class="argumentSet bs-main">
    ...
    <div class='row'>
      ...
      <span class="row-right">
        <Input-number :max="365" :min="7" v-model="setting.saveTime" style="width: 200px;"></Input-number>
  ...
  watch: {
    'setting.saveTime'(newVal, oldVal) {
      if (typeof newVal === 'number') {
        this.setting.saveTime < 7 && (this.setting.saveTime = 7)
      } else {
        this.setting.saveTime = 7
      }
    },
