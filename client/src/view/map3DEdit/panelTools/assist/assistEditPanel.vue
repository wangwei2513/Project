...
<template>
  <div class="panel">
    ...
    <div class="panel_foot">
      <Button type="ghost" @click="cancelSaveAssistHolePoint('pointInfo')" style="margin-right: -3px" title="点击取消保存点位信息">取消</Button>
      <Button type="primary" @click="saveAssistHolePoint('pointInfo')" style="margin-left: 16px" title="点击保存点位信息">保存</Button>
    </div>
  </div>
</template>
<script>
