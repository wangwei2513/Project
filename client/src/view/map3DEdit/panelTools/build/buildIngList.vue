    ...
    <div class="table-height">
      <bs-scroll ref="scroller" class="table-height">
        ...
        <div class="page-margin">
          <Page placement='bottom' size="small" :page-size-opts="$PageInfo.size" :total="buildPage.count" :page-size="buildPage.limit" :current="buildPage.cur" @on-change="changePage" @on-page-size-change="pageSizeChange" show-sizer show-total></Page>
        </div>
      </bs-scroll>
...
export default {
  ...
  watch: {
    buildList(val) {
      this.buildPage.count = val.length
    }
  },
  methods: {
    ...mapActions([
