  ...
  <div class="panel">
    ...
    <div class="panel_content">
      ...
      <div v-show="!is3DMapOuter || selectedTab==='resource'" class="subPanel">
        <div class="videoForm">
          <p>基本信息</p>
          <Form ref="alarmData" :rules="validateRule" :model="alarmData" :label-width="75" label-position="left">
    ...
    <div class="panel_foot">
      <Button type="ghost" @click="cancelSave('alarmData')" style="margin-right: -3px" title="点击取消保存点位信息">取消</Button>
      <Button type="primary" @click="saveAlarmPoint('alarmData')" style="margin-left: 16px" title="点击保存点位信息">保存</Button>
    </div>
  </div>
</template>
<script>
