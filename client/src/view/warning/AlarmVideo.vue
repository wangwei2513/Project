<template>
  <div style="height: 100%">
    <AlarmVideoPreview :class="{outofscreen: isPlayback === true}" :toggleView.sync="isPlayback" ref="AlarmVideoPreview"></AlarmVideoPreview>
    <AlarmVideoPlayback :class="{outofscreen: isPlayback === false, noshow: isPlayback === null}" :toggleView.sync="isPlayback" ref="AlarmVideoPlayback"></AlarmVideoPlayback>
  </div>
</template>
<script>
