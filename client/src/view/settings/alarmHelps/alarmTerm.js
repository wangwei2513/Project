export default {
  ...
  methods: {
    ...
    alarmBoxConfig(index, data) {
      ...
      this.configBoxData.actionOutCtl = data.actionOutCtl.length === 0 ? contrl : data.actionOutCtl
      this.configBoxData.actionloc = JSON.parse(JSON.stringify(data.actionloc))
      this.dataActionVideo = data.actionVideo
      let treeList = []
