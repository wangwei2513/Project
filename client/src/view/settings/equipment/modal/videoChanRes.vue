  ...
  <Modal :mask-closable="false" v-model="resModal" :title="isResEdit?'资源修改':'资源添加'" width="500" @on-cancel="cancel('formData')">
    <Form :model="formData" :label-width="100" :rules="formValidate" ref="formData" label-position="left" style="padding: 0 20px;">
      ...
      <Row class="check-input">
        ...
        <Col span="16">
        <Input-number :disabled="!formData.isprerecord" :min="1" :max="30" v-model="formData.precord" style="width:316px"></Input-number>
        </Col>
      </Row>
      <Row class="check-input">
        <Col span="8">
        ...
        <Col span="16">
        <Input-number :disabled="!formData.isdelayrecord" :min="1" :max="3600" v-model="formData.delayrecord" style="width:316px"></Input-number>
        </Col>
      </Row>
    </Form>
    <div slot="footer">
