<template>
  <div class="bs-resource-manage bs-content">
        ...
        <div class="table-header">
          ...
          <div class="table-header-actions clear">
            <div class="actions-btn">
              ...
              <Select style="width:120px" placeholder="同步通道名称" v-model="channelNameSyncSelect" v-if="$BShasPower('BS-SETTING-RESOURCE-VIDEO-MANAGE')&&tabIndex===0">
    ...
    <!-- 资源添加弹出框 -->
    <Modal :mask-closable="false" v-model="resAddModal" :title="tabIndex===0?'资源分配': (tabIndex === 1 ? '视频通道rtsp流分配' : '报警求助设备')" width="450" @on-cancel="resAddCancel">
