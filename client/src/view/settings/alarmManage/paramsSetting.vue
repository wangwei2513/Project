    ...
    <div class="set-flex">
      <div class="rank">
        ...
        <div class="rank-config">
          ...
          <!--修改级别配置-->
          <Modal v-model="editRankMod" title="修改级别配置" :mask-closable="false">
            <Form :model="rankEditForm" ref="rankEditForm" label-position="left" :label-width="90" :rules="ruleValidate"  style="padding: 0 10px;">
              ...
              <Form-item label="播放次数(次)" prop="playTime">
                <Input v-model="rankEditForm.playTime" />
              </Form-item>
        ...
        <div class="alarm-deal">
          <div class="panel">
            ...
            <Checkbox v-model="enable" class="panel-enable" @on-change="enableChange">启用</Checkbox>
          </div>
          <div class="table-relative" style="height: 391px;">
            <div class="table-body">
