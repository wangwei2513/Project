<template>
  <div class="tv-body" style="flex:1">
    ...
    <AddTVWall v-if="isAddTVWall" :isAddTVWall.sync="isAddTVWall" @cancel="cancel"></AddTVWall>
    <ErrorModel :errorInfo="errorInfoArray" @onError="saveErrorInfo"></ErrorModel>
  </div>
</template>
<script>
import AddTVWall from './tvwall/AddTVWall'
import TVwallTab from './tvwall/TVwallTab'
import ErrorModel from './tvwall/ErrorModel'
