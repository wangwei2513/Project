(function(window) {
  ...
  function Plugin($container, options) {
    ...
    let $viewport = $container.querySelectorAll('.viewport')[0]
    let $overview = $container.querySelectorAll('.overview')[0]
    let $scrollbar = $container.querySelectorAll('.scrollbar')[0]
    let $track = $scrollbar.querySelectorAll('.track')[0]
    let $thumb = $scrollbar.querySelectorAll('.thumb')[0]
