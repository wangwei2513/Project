<template>
  ...
  <div id="menu">
    ...
    <div style="padding:0px;height:calc(100% - 88px)" v-if="showTree">
      ...
      <organization v-show="menuTag==='org'" :showAdd="showAdd" ref="org" :synchro="synchro" :searchVal="searchVal"  @changeNodeId="changeNodeId">
      </organization>
      <favorites v-show="menuTag==='fav'" :showAdd="showAdd" ref="fav" :synchro="synchro" :searchVal="searchVal"  @changeNodeId="changeNodeId">
      </favorites>
    </div>
      ...
      <div class="sharePanelBox">
        ...
        <div class="content">
          ...
          <div class="table">
            ...
            <Table :columns="userColumns" class="s-table" ref="table" :data="userList" size="small" @on-selection-change="selectChange" height="192"></Table>
...
export default {
  ...
  methods: {
    ...mapActions(['getvideoOrg', 'getFavorites', 'setFavorites', 'shareFavorites', 'getUserAll']),
    shareClick() {
