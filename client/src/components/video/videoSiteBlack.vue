...
export default {
  ...
  methods: {
    ...mapActions(['queryRecordlist', 'getPlatformID', 'gbQueryRecordList', 'gbRecordOpen', 'gbPlayBackCtrl', 'recordLog']),
    playIndex(index) {
    ...
    */
    ...
    download() {
      ...
      path = path + '\\' + new Date().getTime() + type
      let param
      if (this.sourceType === 2) {
