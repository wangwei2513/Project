  ...
  <div style="height: 100%">
    <div style="height:100%">
      ...
      <div class="btn-con" style="float:right;margin-right:10px">
        ...
        <button :class="['iconfont', pluginState.isVolumeOpen? 'icon-mute': 'icon-volume']" @click="pluginState.isVolumeOpen? closeSound(): openSound()"></button>
        <button class="iconfont icon-b_icon__screenshot" @click="getCapture"></button>
        <button class="iconfont icon-full-screen" @click="fullscreen"></button>
      </div>
    </div>
  </div>
</template>
